    ...
    public class KeyGenerator
    {
        ...
        public static void GeneratePersonalKeyPairSets(Password exportPassword)
        {
            ...
            try
            {
                ...
                //string publicCommunicationKeyBase64 = Convert.ToBase64String(publicEncryptionKey);
                //string privateCommunicationKeyBase64 = Convert.ToBase64String(privateEncryptionKey);
